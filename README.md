...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vrjz5uw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vrjz5uw.containers.anotherwebservice.com/
...
```
git clone git@github.com:ErnestoLara/container-vrjz5uw.git
cd container-vrjz5uw
```
...
```
docker attach container-vrjz5uw
```
